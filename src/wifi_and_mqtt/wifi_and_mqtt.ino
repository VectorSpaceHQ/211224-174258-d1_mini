...
EspMQTTClient espclient(
    ...
    "vectorspace",   // Can be omitted if not needed
    "makerspace",   // Can be omitted if not needed
    "Table Saw2",     // Client name that uniquely identify your device
...
{
    espclient.publish("tools/dust_collection", "Connection Established");
    Serial.println("Serial print: Connection established");
}
