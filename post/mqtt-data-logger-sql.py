...
options["cname"]=""
options["username"]="vectorspace"
options["password"]="makerspace"
options["topics"]=[("tools/dust_collection",0)]

#sql
db_file="/home/vectorspace/mqtt_broker/dust_collection_logs.db"
Table_name="logs"
table_fields={
...
def message_handler(client,msg,topic):
    ...
    data["time"] = str(datetime.datetime.now().replace(microsecond=0))
    data["topic"]=topic
    data["message"]=msg
